...
При умерации списков нумерация идет последовательно например:

5. Элемент - 5. Элемент
9. Элемент - 9. Элемент
11. Элемент - 11. Элемент
...
Команды для отправки локального репозитория в GitHub:

git remote add origin "Ссылка из гит хаба" - команда для задания пути

git branch -M main - говорим гиту что используем свое название репозитория

git push -u origin main - команда для отправки репозитория

Комада для того чтобы перетащить репозиторий из гитхаб в локальный терминал
